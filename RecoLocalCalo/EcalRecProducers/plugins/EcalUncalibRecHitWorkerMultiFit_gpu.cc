  ...
  EcalUncalibRecHitWorkerBaseClass(ps,c)
{
  ...
  // allocate memory for all crystals on gpu
  // ---- the code will work for 
  //            EB: max channels 61200
  //            EE: max channels 14648
  //
  //
                ...
                EcalUncalibratedRecHitCollection & result )
{
    ...
    //
    //---- first loop to create the list of digis to ship to the device
    // h_vector_digis ->clear(); // clear from the previous event
