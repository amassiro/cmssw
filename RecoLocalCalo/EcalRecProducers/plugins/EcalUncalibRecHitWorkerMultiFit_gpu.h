 ...
 * 
 *  New version: restructured, including data structure, 
 *  in order to be compliant with GPU infrastructure.
 *  Optimization and complete change of approach required
 * 
 *  \author A. Massironi
 * 
 */
